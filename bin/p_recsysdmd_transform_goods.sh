...
#*目标表 --%@TARGET_TABLE:recommend.goods
#*执行周期 人工调用
####################################################################
THIS="$0"
...
#分析
#echo "开始分析数据"
$SPARK_HOME/spark-submit --master $SPARK_MASTER_URL --executor-memory 5G --total-executor-cores 24 --class sql.GoodsExportMysql --jars $MYSQL_JAR $JAR_PATH